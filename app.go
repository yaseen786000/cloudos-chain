...
import (
	...
	counter "github.com/yaseen786000/cloudos-chain/x/counter"
	counterkeeper "github.com/yaseen786000/cloudos-chain/x/counter/keeper"
...
func (app *ExampleApp) TxConfig() client.TxConfig {
	return app.txConfig
}
