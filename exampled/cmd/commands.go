...
func initRootCmd(
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(basicManager, example.DefaultNodeHome),
		debug.Cmd(),
		confixcmd.ConfigCommand(),
		pruning.Cmd(newApp, example.DefaultNodeHome),
		snapshot.Cmd(newApp),
	)

	server.AddCommandsWithStartCmdOptions(rootCmd, example.DefaultNodeHome, newApp, appExport, server.StartCmdOptions{
...
func genesisCommand(txConfig client.TxConfig, basicManager module.BasicManager, cmds ...*cobra.Command) *cobra.Command {
	cmd := genutilcli.Commands(txConfig, basicManager, example.DefaultNodeHome)
